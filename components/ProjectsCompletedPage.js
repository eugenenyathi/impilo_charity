      ...
      <div className="completed-projects-page width-container">
        <div className="project-item">
          ...
          <div className="text-wrapper">
            ...
            <p className="section-paragraph">
              A rain harvest system of 1000 liters was installed at one location
        ...
        <div className="project-item">
          ...
          <div className="text-wrapper">
            ...
            <p className="section-paragraph">
              10 solar lights were delivered. The brand was (see insert) Mobiya
              TS 120s Lantern with cell charger
            </p>
          </div>
        </div>
        <div className="project-item">
